...
#
# Script generated by Vivado on Sun Jan 18 04:51:31 -0500 2026
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/user/Desktop/uOttaHack_FPGA/fpga_top/fpga_top.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
